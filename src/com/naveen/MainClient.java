...
public class MainClient extends WindowAdapter implements ActionListener {
	...
	private MainClient() {
		mainFrame = new JFrame("Hidden Secrets");
		...
		// lblLogo= new JLabel(new ImageIcon("./Images/nnn.jpeg"));
		...
		// murthymainPanel.add(panelButtons);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source == mnuExit) {
			int result = JOptionPane.showConfirmDialog(mainFrame, "Are you sure that you want to close Steganograph.",
